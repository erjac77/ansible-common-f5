...
### Ansible F5 iWorkflow module classes ###

class AnsibleModuleF5iWorkflowNamedObject(AnsibleModuleF5NamedObject):
    pass


class AnsibleModuleF5iWorkflowUnnamedObject(AnsibleModuleF5UnnamedObject):
    pass
